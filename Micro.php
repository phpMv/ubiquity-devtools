...
include 'tools/ModelsCreator.php';
...
class Micro {
	...
	public static function create($projectName,$options,$force=false){
		...
		if(!is_dir($projectName) || $force){
			...
			self::downloadZip("https://github.com/phpMv/ubiquity/archive/master.zip","tmp/tmp.zip");
			...
			echo "Files copy...\n";
			FileUtils::xcopy("tmp/ubiquity-master/micro/","app/micro");
			//FileUtils::xcopy($activeDir."/project-files/templates", "app/micro/tools/templates");
