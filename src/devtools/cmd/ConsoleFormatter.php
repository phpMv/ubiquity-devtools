...
class ConsoleFormatter {
	const BLACK='0;30',DARK_GREY='1;30',BLUE='0;34',LIGHT_BLUE='1;34',GREEN='0;32',LIGHT_GREEN='1;32',CYAN='0;36',LIGHT_CYAN='1;36',RED='0;31',LIGHT_RED='1;31',PURPLE='0;35',LIGHT_PURPLE='1;35',BROWN='0;33',YELLOW='1;33',LIGHT_GRAY='0;37',WIGHT='1;37';
	...
	public static function showInfo($content){
	...
	public static function formatHtml($str){
		$reg='@<(b)>(.+?)</\1>@i';
		return preg_replace($reg, "\033[".self::BOLD.'m$2'."\033[".self::END."m", $str);
	}
}
